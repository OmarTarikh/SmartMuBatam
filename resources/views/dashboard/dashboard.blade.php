        ...
        <div class="card chart-card activity-card-wrapper">
            ...
            <div class="card-body activity-body small">
                ...
                <div class="activity-row">
                    <div class="activity-date">Sep</div>

                    <div class="activity-content">
                        <div class="activity-heading">GOTONG ROYONG</div>
                ...
                <!-- ITEM -->
                <div class="activity-row">
                    <div class="activity-date">Jan</div>

                    <div class="activity-content">
                        <div class="activity-heading">RAPAT</div>
                ...
                <!-- ITEM -->
                <div class="activity-row">
                    <div class="activity-date">Okt</div>

                    <div class="activity-content">
                        <div class="activity-heading">PENGAJIAN</div>

                        <div class="activity-box green">
                            <div>12 Okt 2025</div>
                            <div>07.00 - 10.00</div>
                            <div>Masjid Agung</div>
                        </div>
                    </div>
                </div>
