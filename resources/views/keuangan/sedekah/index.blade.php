@extends('layouts.app')
@section('title', 'Keuangan > Sedekah')
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-4 mb-4">
        ...
        <div class="d-flex align-items-center gap-3 flex-wrap">
            ...
            <!-- ADD -->
            <a href="{{ route('keuangan.sedekah.tambah') }}"
            ...
            <!-- PDF -->
            <a href="{{ route('keuangan.sedekah.pdf') }}"
               target="_blank"
    ...
    <div class="d-flex justify-content-between align-items-center mt-4 flex-wrap gap-3">
        ...
        <div class="custom-pagination d-flex align-items-center">
            ...
            @php
                ...
                $start = max($sedekahs->currentPage() - 2, 1);

                $end = min($start + 4, $sedekahs->lastPage());
            ...
            @for($page = $start; $page <= $end; $page++)
                ...
                <a
                    href="{{ $sedekahs->url($page) }}"
                    class="page-btn {{ $page == $sedekahs->currentPage() ? 'active' : '' }}">
            ...
            {{-- Berikutnya --}}
            @if($sedekahs->hasMorePages())

                <a
                    href="{{ $sedekahs->nextPageUrl() }}"
...
@include('keuangan.sedekah.modals.detail')
@include('keuangan.sedekah.modals.edit')
@include('keuangan.sedekah.modals.delete')
