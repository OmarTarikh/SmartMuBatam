{{-- ========================================
     resources/views/keuangan/sedekah/modals/edit.blade.php
======================================== --}}
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input
                                ...
                                value="{{ number_format(optional($item->sedekah)->jumlah ?? 0,0,',','.') }}">

                            <input
                                type="hidden"
                                name="jumlah"
                                class="jumlah-real"
                                value="{{ optional($item->sedekah)->jumlah }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea
                            name="keterangan"
                            rows="4"
                            class="form-control custom-input">{{ optional($item->sedekah)->keterangan }}</textarea>
