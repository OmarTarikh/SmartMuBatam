@extends('layouts.app')
@section('title', 'Aset Keuangan > Kas')
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-4 mb-4">
        ...
        <div class="d-flex align-items-center gap-3 flex-wrap">
            ...
            <!-- ADD -->
            <a href="{{ route('keuangan.kas.tambah') }}"
    ...
    <div class="d-flex justify-content-between align-items-center mt-4 flex-wrap gap-3">
        ...
        <div class="custom-pagination d-flex align-items-center">
            ...
            @for($page = $start; $page <= $end; $page++)
                ...
                <a
                    href="{{ $kas->url($page) }}"
                    class="page-btn {{ $page == $kas->currentPage() ? 'active' : '' }}">
...
@include('keuangan.kas.modals.detail')
@include('keuangan.kas.modals.edit')
@include('keuangan.kas.modals.delete')
